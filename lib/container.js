module.exports = function(customParams) {
    ...
    this.mergeParameters = function(values) {
        ...
        params = mergeObjects(params, values);
     ...
     * @param  {String}  id The id of the parameter.
     *
     * @return {Boolean} Returns true if the parameter exists, otherwise returns false.
     */
    this.hasParameter = function(id) {
        ...
        return parts.every(function(part, i) {
            ...
            if (i == lastPartNum) {
                return (data.hasOwnProperty(part));
            } else if (typeof(data[part]) == 'object') {
                data = data[part];
            } else {
                return false;
